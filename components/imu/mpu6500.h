...
////////////////////////////////////////////////////////////////////////////////
//
//      MPU6500 axis convention is ENU
//        X: Right positive
//        Y: Forward positive
//        Z: Upward positive
//
...
//        Fingers curl in the positive rotation
//
//      Accelerometer convention 
//        Positive acceleration value along the axis direction
//
////////////////////////////////////////////////////////////////////////////////
/* MPU6500 registers */
...
typedef struct
{
  MPU6500_Accelerometer_t   accel_config;
  MPU6500_Gyroscope_t       gyro_config;
  uint64_t                  num_transactions;
  uint64_t                  num_failed;
} mpu6500_t;

extern void mpu6500_init(mpu6500_t* mpu6500,
    MPU6500_Accelerometer_t accel_sensitivity,
    MPU6500_Gyroscope_t gyro_sensitivity,
    imu_raw_to_real_t* lsb);

extern bool mpu6500_read_gyro_accel(mpu6500_t* mpu6500, imu_sensor_data_t* imu);
